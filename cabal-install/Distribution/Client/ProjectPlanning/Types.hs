...
data ElaboratedConfiguredPackage
   = ElaboratedConfiguredPackage {
       ...
       elabInstantiatedWith :: ModuleSubst,
...
elabOrderLibDependencies elab =
    case elabPkgOrComp elab of
        ElabPackage _      -> map (SimpleUnitId . confInstId) (elabLibDependencies elab)
...
elabOrderExeDependencies =
    map SimpleUnitId . elabExeDependencies
...
data ElaboratedComponent
   = ElaboratedComponent {
    ...
    compLinkedLibDependencies :: [UnitId],
...
compOrderExeDependencies = map SimpleUnitId . compExeDependencies
