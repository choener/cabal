...
-- TODO: move this to cabal-install
...
computeCompatPackageName pkg_name CLibName (Just (SimpleUnitId _))
    = pkg_name
computeCompatPackageName pkg_name CLibName (Just (UnitId _ _))
    = pkg_name
...
computeCompatPackageKey _comp _pkg_name _pkg_version uid@UnitId{}
    = display uid
computeCompatPackageKey _comp _pkg_name _pkg_version uid@HashedUnitId{}
    = display uid
